...
#ifdef DEBUG_ON
               DebugSerial.println("DB:NOT CONN");
#endif
               n_of_at++;
          } else {
               connected=true;
...
int InetGSM::attachGPRS(char* domain, char* dom1, char* dom2)
{
     ...
     if(gsm.WaitResp(5000, 50, "ERROR")!=RX_FINISHED_STR_RECV) {
#ifdef DEBUG_ON
          DebugSerial.println("DB:ALREADY HAVE AN IP");
#endif
...
#ifdef DEBUG_ON
          DebugSerial.println("DB:STARTING NEW CONNECTION");
#endif
...
#ifdef DEBUG_ON
          DebugSerial.println("DB:SHUTTED OK");
#endif
          delay(1000);
...
#ifdef DEBUG_ON
          DebugSerial.println("DB:CONNECTION OK");
#endif
          ...
          if(gsm.WaitResp(5000, 50, "ERROR")!=RX_FINISHED_STR_RECV) {
#ifdef DEBUG_ON
               DebugSerial.println("DB:ASSIGNED AN IP");
#endif
               gsm.setStatus(gsm.ATTACHED);
               return 1;
          }
#ifdef DEBUG_ON
          DebugSerial.println("DB:NO IP AFTER CONNECTION");
#endif
          return 0;
     }
}
...
#ifdef DEBUG_ON
     DebugSerial.println("DB:RECVD CMD");
#endif
